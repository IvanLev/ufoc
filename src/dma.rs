use stm32ral::{dma, dmamux, write_reg, read_reg, modify_reg};
...
impl DMAMux {
    ...
    pub fn set(&self, channel: u32, id: u32) {
        match channel {
            0 => write_reg!(dmamux, self.dmamux, CCR0, DMAREQ_ID: id),
            1 => write_reg!(dmamux, self.dmamux, CCR1, DMAREQ_ID: id),
            2 => write_reg!(dmamux, self.dmamux, CCR2, DMAREQ_ID: id),
            3 => write_reg!(dmamux, self.dmamux, CCR3, DMAREQ_ID: id),
            4 => write_reg!(dmamux, self.dmamux, CCR4, DMAREQ_ID: id),
            5 => write_reg!(dmamux, self.dmamux, CCR5, DMAREQ_ID: id),
            6 => write_reg!(dmamux, self.dmamux, CCR6, DMAREQ_ID: id),
            7 => write_reg!(dmamux, self.dmamux, CCR7, DMAREQ_ID: id),
            8 => write_reg!(dmamux, self.dmamux, CCR8, DMAREQ_ID: id),
            9 => write_reg!(dmamux, self.dmamux, CCR9, DMAREQ_ID: id),
            10 => write_reg!(dmamux, self.dmamux, CCR10, DMAREQ_ID: id),
            11 => write_reg!(dmamux, self.dmamux, CCR11, DMAREQ_ID: id),
            12 => write_reg!(dmamux, self.dmamux, CCR12, DMAREQ_ID: id),
            13 => write_reg!(dmamux, self.dmamux, CCR13, DMAREQ_ID: id),
            14 => write_reg!(dmamux, self.dmamux, CCR14, DMAREQ_ID: id),
            15 => write_reg!(dmamux, self.dmamux, CCR15, DMAREQ_ID: id),
