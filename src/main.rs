...
mod app {
    ...
    fn init(mut cx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        write_reg!(dma, dma1, CCR1, TCIE: 1, EN: 1);
        write_reg!(dma, dma1, CCR2, TCIE: 1, EN: 1);
        ...
        defmt::println!("Hello, world! And RTIC!");
